<?php
 ...
 ?>
    <div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        <div class="col-md-8" style="max-width:93vw">
...
if($post['uid']==$user['id']){
  ...
  <ul class="dropdown-menu" aria-labelledby="option<?=$post['id']?>">
    ...
    <li><a class="dropdown-item" href="assets/php/actions.php?deletepost=<?=$post['id']?>"><i class="bi bi-trash-fill"></i> add post</a></li>
  </ul>
</div>
    <?php
}
